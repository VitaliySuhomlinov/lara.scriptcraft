...
<div class="wrapper">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        <a href="{{ route('/') }}" class="brand-link">
            <img src="{{ asset('assets/admin/img/S_logo.png') }}" alt="ScriptCraft Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
            <span class="brand-text font-weight-light">ScriptCraft</span>
        </a>
